/**
 <b>Load content via Ajax </b>.
 For more information please refer to documentation #basics/ajax
 */
...
(function ($, undefined) {
	...
	function AceAjax(contentArea, settings) {
		...
		this.getUrl = function (url, hash, manual_trigger, method, data, updateView, extraParams) {
			...
			var ajax_params = method == 'GET' ? {'url': url, 'cache': !this.force_reload} : {
				'url': url,
				'method': 'POST',
				'data': data
			}
